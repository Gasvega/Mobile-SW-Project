    ...
    return (
        <View style={{backgroundColor: '#fff'}}>
            ...
            <TouchableOpacity 
                ...
                onPress={() => props.navigation.navigate("quizopen",{num:1,text:Quiz1,email:props.route.params})}>
            ...
            {/* Quiz2 */}
                ...
                <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:2,text:Quiz2,email:props.route.params})}
            >
            ...
            <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:3,text:Quiz3,email:props.route.params})}
            >
            ...
            <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:4,text:Quiz4,email:props.route.params})}
            >
            ...
            <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:5,text:Quiz5,email:props.route.params})}
            >
            ...
            <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:6,text:Quiz6,email:props.route.params})}
            >
            ...
            <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:7,text:Quiz7,email:props.route.params})}
            >
            ...
            <TouchableOpacity 
                style = {styles.buttonstyle}
                onPress={() => props.navigation.navigate("quizopen",{num:8,text:Quiz8,email:props.route.params})}
            >
